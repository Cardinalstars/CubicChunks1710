...
public class ColumnIOProvider implements
    AsynchronousExecutor.CallBackProvider<QueuedColumn, ICubeIO.PartialData<Chunk>, Consumer<Chunk>, RuntimeException> {
    ...
    public ICubeIO.PartialData<Chunk> callStage1(QueuedColumn queuedColumn) throws RuntimeException {
        ...
        try {
            ...
            CubicChunks.LOGGER
                .error("Could not load column in {} @ ({}, {})", queuedColumn.world, queuedColumn.x, queuedColumn.z, e);
        }
    ...
    public void callStage2(QueuedColumn queuedColumn, ICubeIO.PartialData<Chunk> columnData) throws RuntimeException {
        if (columnData == null) {
            throw new RuntimeException(
                "Corrupted column at " + queuedColumn.x + ", " + queuedColumn.z,
                queuedColumn.exception);
        }
    ...
    @Override
    public void callStage3(QueuedColumn queuedColumn, ICubeIO.PartialData<Chunk> columnData, Consumer<Chunk> callback)

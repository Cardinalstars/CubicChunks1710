...
public enum Mixins implements IMixins {
    ...
    MIXIN_STRUCTURE_START(
        new MixinBuilder("Giving Y position to structures.").addCommonMixins("common.MixinStructureStart")
            ...
            .setApplyIf(() -> true)),
    MIXIN_PATH_NAVIGATE(
        new MixinBuilder("Fixing casting issues for doubles to ints if they are negative.").addCommonMixins("common.MixinPathNavigate")
            .setPhase(Phase.EARLY)
            .setApplyIf(() -> true)),
    MIXIN_ENTITY_MINECART(
        new MixinBuilder("Fixing minecarts getting auto-killed below y = -64").addCommonMixins("common.MixinEntityMinecart")
            .setPhase(Phase.EARLY)
            .setApplyIf(() -> true)),
    MIXIN_PATH_FINDER(

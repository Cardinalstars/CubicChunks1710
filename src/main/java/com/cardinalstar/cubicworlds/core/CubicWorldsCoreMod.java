package com.cardinalstar.cubicworlds.core;

import java.util.List;
import java.util.Map;
import java.util.Set;

import com.cardinalstar.cubicworlds.mixin.Mixins;
...
public class CubicWorldsCoreMod extends DummyModContainer implements IFMLLoadingPlugin, IEarlyMixinLoader {
    ...
    public String getMixinConfig() {
        return "mixins.cubicworlds.early.json";
    }
